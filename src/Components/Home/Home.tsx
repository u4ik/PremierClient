    ...
    render() {
        return (
            <div style={{height:"auto", backgroundColor:'#009FE4'}}>
                <h3 style={{fontSize:'1.7rem',paddingTop:'1%', textShadow:'1.5px 2px 1px #024160', color:'#E8C10D', userSelect:'none', marginBottom: '1%', paddingBottom: '1%', backgroundColor: '#177BBD', borderTop: 'solid 1px white'}}>About</h3>
                <div style={{ display: 'flex', flexDirection:'row', justifyContent:'center', paddingBottom:'3%'}} >
                    <div style={{display:'flex',flexDirection: 'column',width:'70%',}}>
                        ...
                        <div style={{backgroundColor:'white', filter:'drop-shadow(2px 2px 2px black', borderRadius:'10px', padding:'1%', textAlign:'center'}}>
